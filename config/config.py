...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7548822418").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/BOT_OWNER_OP"
)  # Example:- https://t.me/TheTeamVivek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/BOT_OWNER_OP"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/BOT_OWNER_OP")
